# Commit 9/9 — Mostrar el mapa del punto de encuentro en Editar servicio
...
Ultimo commit: se integra el mapa dentro de la pantalla de edicion,
mostrando la ubicacion que quedo guardada la ultima vez que se
geocodifico la direccion. Esta pantalla (formulario + mapa) es la
captura clave para la seccion "Consumo de Web Service de terceros" del
documento tecnico.
...
```powershell
git add resources/js/pages/Services/Edit.vue
git commit -m "feat(services): mostrar el mapa del punto de encuentro en Editar servicio"
