# Commit 7/9 — Panel de administracion de usuarios
...
Modulo de Administracion de usuarios completo: cambiar rol y
activar/desactivar cuentas desde una tabla editable. Se copian los
props a `localUsers` (reactive) para poder editar cada fila sin mandar
un form por usuario.
...
**Archivo:** `resources/js/pages/Admin/Users.vue`
...
git commit -m "feat(admin): crear panel de administracion de usuarios"
```
